...
- Campaign phase: `weaponmod-da-catalog-read` (placeholder)
- Blocked reason: Future DataAsset catalog phase; implement after perk catalog evidence and safety review.
- Selection reason: No imported read-only catalog snapshot has been selected yet for Weapon Mod DataAsset Catalog. Current outputs document only related objectdump/shallow runtime evidence and the campaign placeholder phase.

## Known Model

- PlayerState array property: `CrabPS.WeaponMods`
- Related slot scalar property: `CrabPS.NumWeaponModSlots`
- Wrapper class: `CrabWeaponMod`
- DataAsset property path: `CrabWeaponMod.WeaponModDA`
