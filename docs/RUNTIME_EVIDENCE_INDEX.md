...
- Access evidence files: 23
- Probe result files: 22
- Diagnostic summaries: 22
- Evidence rows: 628
...
| `CrabPS.WeaponMods` | GetPropertyValueLuaLenPcall | solo | solo-or-host | SAFE | ok | 20260506T052733Z | Read-only local CrabPC -> PlayerState -> CrabPS array wrapper count metadata using only pcall(#value); no traversal, element dereference, item DataAsset reads, InventoryInfo, Enhancements, writes, RPCs, HUD, or deep arrays |
