...
- Campaign phase: `abilitymod-da-catalog-read` (placeholder)
- Blocked reason: Future DataAsset catalog phase; implement after perk catalog evidence and safety review.
- Selection reason: No imported read-only catalog snapshot has been selected yet for Ability Mod DataAsset Catalog. Current outputs document only related objectdump/shallow runtime evidence and the campaign placeholder phase.

## Known Model

- PlayerState array property: `CrabPS.AbilityMods`
- Related slot scalar property: `CrabPS.NumAbilityModSlots`
- Wrapper class: `CrabAbilityMod`
- DataAsset property path: `CrabAbilityMod.AbilityModDA`
...
- Objectdump signals: CrabPS.AbilityMods, CrabPS.NumAbilityModSlots, CrabAbilityMod, CrabAbilityMod.AbilityModDA
Source files:
