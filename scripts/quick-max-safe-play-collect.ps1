...
Write-Host "summary = max_safe_play_scalar_sample_count $sampleCount; max_safe_play_perk_catalog_snapshot_count $catalogSnapshots; max_safe_play_perk_da_entry_count $entryCount"
