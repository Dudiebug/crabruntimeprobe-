...
foreach ($key in @("allowIdentityProbes", "allowRawIdentityEvidence", "allowResourceVisibilityProbes", "allowInventoryArrayShallowProbes", "allowInventoryArrayShapeConfirmProbes", "allowInventoryUserdataIntrospectionProbes")) {
...
foreach ($forbidden in @("allowWriteProbes = true", "allowRpcProbes = true", "allowHudTickHook = true", "allowDeepArrayProbes = true", "allowInventoryInfoProbes = true", "allowHealthProbes = true", "allowResourceVisibilityProbes = true", "allowInventoryArrayShallowProbes = true", "allowInventoryArrayShapeConfirmProbes = true", "allowInventoryUserdataIntrospectionProbes = true")) {
