...
foreach ($key in @("allowIdentityProbes", "allowRawIdentityEvidence", "allowResourceVisibilityProbes", "allowInventoryArrayShallowProbes", "allowInventoryArrayShapeConfirmProbes")) {
...
foreach ($forbidden in @("allowWriteProbes = true", "allowRpcProbes = true", "allowHudTickHook = true", "allowDeepArrayProbes = true", "allowInventoryInfoProbes = true", "allowHealthProbes = true", "allowResourceVisibilityProbes = true", "allowInventoryArrayShallowProbes = true", "allowInventoryArrayShapeConfirmProbes = true")) {
