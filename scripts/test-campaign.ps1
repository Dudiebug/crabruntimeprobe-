...
userdata = helpers.classifyLocalInventoryUserdataIntrospectionEvidence([
  { probeName: 'Inventory.LocalArrays.UserdataIntrospection', result: 'ok', localPlayerStatePresent: true, fieldsReadable: ['WeaponMods'], valueKinds: { WeaponMods: 'userdata' }, lenOperatorAttempted: { WeaponMods: true }, noElementDereference: true, noArrayTraversal: true, noInventoryInfo: true, noEnhancements: true, noWrites: true, noRpcs: true, noHud: true, noDeepArrays: true, safetyGates: { allowInventoryUserdataIntrospectionProbes: true, allowInventoryArrayShallowProbes: false } }
], { crashSuspect: true });
...
userdata = helpers.classifyLocalInventoryUserdataIntrospectionEvidence([
  { probeName: 'Inventory.LocalArrays.UserdataIntrospection', result: 'ok', localPlayerStatePresent: true, fieldsReadable: ['WeaponMods'], valueKinds: { WeaponMods: 'userdata' }, lenOperatorAttempted: { WeaponMods: true }, noElementDereference: false, noArrayTraversal: true, noInventoryInfo: true, noEnhancements: true, noWrites: true, noRpcs: true, noHud: true, noDeepArrays: true, safetyGates: { allowInventoryUserdataIntrospectionProbes: true } }
]);
